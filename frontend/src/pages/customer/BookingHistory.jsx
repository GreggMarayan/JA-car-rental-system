            ...
            <table className="w-full text-sm border border-gray-300">
              <thead>
                <tr className="bg-gray-100">
                  ...
                  <th className="border border-gray-300 px-8 py-0.5">Start Date - End Date</th>
              ...
              <tbody>
                <tr className="text-center">
                  <td className="border border-gray-300 px-2 py-1">3/29/2025</td>
                  <td className="border border-gray-300 px-2 py-1">Terra</td>
                  <td className="border border-gray-300 px-2 py-1">SUV </td>
                  <td className="border border-gray-300 px-2 py-1">04/15/2025 - 04/18/2025</td>
              ...
              <tbody>
                <tr className="text-center">
                  ...
                  <td className="border border-gray-300 px-2 py-1">Terra</td>
                  <td className="border border-gray-300 px-2 py-1">SUV </td>
                  <td className="border border-gray-300 px-2 py-1">05/01/2025 - 05/04/2025</td>
                  <td className="border border-gray-300 px-2 py-1">3,000 </td>
                  <td className="border border-gray-300 px-2 py-1">Cancelled</td>
                </tr>
              </tbody>
            </table>
          </DashboardCard>
